---
title: 'tsup에서 tsdown, 번들 크기 다이어트하기'
...
자세한 내용은 [이전 포스트](https://m2na.dev/posts/react-compact-toast-part2#3-%EB%B2%88%EB%93%A4%EB%A7%81-%EB%8F%84%EA%B5%AC-%EC%84%A0%ED%83%9D:~:text=%EB%94%94%EB%B2%84%EA%B9%85%ED%95%A0%20%EC%88%98%EB%8F%84%20%EC%9E%88%EC%96%B4%EC%9A%94.-,3.%20%EB%B2%88%EB%93%A4%EB%A7%81%20%EB%8F%84%EA%B5%AC%20%EC%84%A0%ED%83%9D,-%EC%B2%98%EC%9D%8C%EC%97%90%EB%8A%94%20%EB%B2%88%EB%93%A4%EB%A7%81%20%EB%8F%84%EA%B5%AC%EB%A1%9C)에서 확인할 수 있어요.

하지만, **2025년 8월부터 tsup은 "거의 유지보수 중단" 상태가 됐어요.**  
...
그래서 새로운 번들러로의 마이그레이션을 결심하게 됐어요.

## 2. tsdown, 차세대 번들러의 등장

tsup의 리드미를 보면 maintainer가 **tsdown**으로 마이그레이션을 권장하고 있어요.  
해당 글을 읽고, 저는 고민 없이 tsdown으로 마이그레이션을 결정했어요.

tsdown의 핵심 특징만 간단하게 알아볼게요.
...
[공식문서](https://tsdown.dev/reference/api/Interface.Options)에서 더 많은 API Reference를 확인할 수 있어요.
...
라이브러리를 제작하면서 번들 크기 최적화에 엄청난 집착을 했었는데, tsdown으로 빠르게 변경하지 않은게 후회될 정도에요..ㅎ
...
**tsdown**은 성능, 속도, 유지보수, 호환성 모든 측면에서 tsup의 완벽한 후속 제품이라고 생각해요.

tsup 유지보수 중단 선언 이후, [react-compact-toast](https://github.com/m2na7/react-compact-toast) 라이브러리는 tsdown 덕분에 **24% 더 가볍고 더 빠른 번들**로 재탄생(?)할 수 있었어요.
