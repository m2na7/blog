...
description: request waterfall 현상을 해결하며, 홈 페이지 진입속도를 약 73% 단축시킨 경험을 공유해요.
author: 강민하
date: '2025-07-29'
...
## 2. Suspense와 useSuspenseQuery가 만났을 때 생기는 문제
...
## 4. useSuspenseQueries로 병렬 처리 하기
