...
export default function PostListSkeleton({ className }: Props) {
  return (
    <article
      className={cn(
        'border-b border-gray-300 px-2 py-6 last:border-b-0 dark:border-zinc-700',
        className
      )}
    >
        ...
        <div className="flex items-start justify-between gap-6">
          <div className="flex items-start gap-4">
            <div className="flex-shrink-0">
              <div className="h-18 w-18 rounded-lg bg-gray-200 dark:bg-zinc-700"></div>
            </div>

            <div className="min-w-0 flex-1 space-y-3">
              <div className="mt-2 mb-4 h-5 w-80 rounded bg-gray-200 dark:bg-zinc-700"></div>
